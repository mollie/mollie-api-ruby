class Application < Sinatra::Application
  ...
  swagger_path '/v2/customers/{id}' do
  ...
  swagger_path '/v2/customers/{customer_id}/payments' do
  ...
  get '/v2/customers/:customer_id/payments' do
  ...
  post '/v2/customers/:customer_id/payments' do

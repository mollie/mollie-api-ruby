class Application < Sinatra::Application
  ...
  swagger_path '/v2/settlements/{id}' do
  ...
  swagger_path '/v2/settlements/next' do
  ...
  swagger_path '/v2/settlements/open' do
